...
socket.on('chat', function(data){
    ...
    let msgStr = 
    `<li class="list-group-item list-group-item-dark"><span style="color: blue; font-weight: bolder;">${data['msgUsername']}:</span> ${data['msg']}<span style="float: right;">${data['msgTimestamp']}</span>
